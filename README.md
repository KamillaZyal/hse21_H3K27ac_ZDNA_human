...
- После пересечений гистоновой метки и стр-ры ДНК было получено 13121 пиков (DeepZ содержит 19294 пика).
- Большая часть пиков после финальной обработки расположена на промоторах, что подтверждаяет функцию гистонной метки, а так же особенности метода DeepZ (см. диаграмму пай-чарт для DeepZ).
